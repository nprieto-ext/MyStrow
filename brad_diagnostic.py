...
class BradDiagnosticDialog(QDialog):
    ...
    def __init__(self, window):
        ...
        self._status_lbl = QLabel(tr("bd2_starting"))
        ...
        # ── Boutons ──
        btn_row = QHBoxLayout()
        self._copy_btn = QPushButton(tr("bd2_copy_report"))
    ...
    def _on_done(self, results: list):
        ...
        self._status_lbl.setText(tr("bd2_finished"))
        self._fixable = {}
    ...
    def _copy_report(self):
        ...
        self._copy_btn.setText(tr("bd2_copied"))
        QTimer.singleShot(2000, lambda: self._copy_btn.setText(tr("bd2_copy_report")))
