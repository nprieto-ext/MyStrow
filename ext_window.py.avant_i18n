...
class ExtWindow(QMainWindow):
    ...
    def _edit_master_settings(self, blk: "ExtBlock"):
        ...
        dlg = QDialog(self)
        dlg.setWindowTitle("Réglages du bloc master")
        ...
        lay.addWidget(hdr)
        lay.addWidget(QLabel("De combien le master monte / descend, et en combien de temps."))
        lay.addSpacing(6)

        lay.addWidget(QLabel("Pas (%)"))
        sp_step = QSpinBox()
    ...
    def _edit_block_groups(self, blk: "ExtBlock"):
        ...
        accent = blk.spec.get("color", "#00d4ff")
        dlg = QDialog(self)
        dlg.setWindowTitle("Cible de la couleur" if is_color
