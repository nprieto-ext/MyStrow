...
class _MovePanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._title = QLabel(tr("p32_none_selected"))
        ...
        desel = QPushButton(tr("p32_deselect"))
...
class Plan3DWindow(QMainWindow):
    ...
    def _to_data(self, projectors):
        ...
        for i, p in enumerate(projectors):
            ...
            # Fixture allumée uniquement sur un canal dédié (bloc UV / Ambre) :
            # son RVB est volontairement à zéro, le faisceau serait donc invisible
            # en 3D alors qu'elle éclaire. Teinte d'affichage, comme le plan 2D.
            if not (r or g or b):
                from core import special_tint_color
                _t = special_tint_color(p)
                r, g, b = _t.red(), _t.green(), _t.blue()
