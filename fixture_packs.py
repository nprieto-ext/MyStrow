...
class FixturePackBanner(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._btn_dl = QPushButton(tr("fp2_download"))
...
class FixturePackDownloadDialog(QDialog):
    ...
    def __init__(self, packs: list, id_token: str = None, parent=None):
        ...
        self.setWindowTitle(tr("fp2_title"))
    ...
    def _build_ui(self):
        ...
        # Pack courant
        self._cur_label = QLabel(tr("fp2_preparing"))
        ...
        self._counter_lbl = QLabel(tr("fp2_zero_new"))
    ...
    def _on_all_done(self, total_new: int, total_packs: int):
        ...
        if total_new > 0:
            ...
            self._counter_lbl.setText(tr("fp2_up_to_date"))
