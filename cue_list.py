...
class _SliderPopup(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Ligne titre + valeur
        top = QHBoxLayout()
        self._key_lbl = QLabel(tr("cl2_duration"))
...
class CueListPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        # Placeholder
        self._placeholder = QLabel(tr("cl2_open_cues"))
    ...
    def _on_table_context_menu(self, pos):
        ...
        """)
        n = len(self.cues)
        top    = menu.addAction(tr("cl_move_first"))
        up5    = menu.addAction(tr("cl_move_up5"))
        up     = menu.addAction(tr("cl_move_up"))
        menu.addSeparator()
        down   = menu.addAction(tr("cl_move_down"))
        down5  = menu.addAction(tr("cl_move_down5"))
        bot    = menu.addAction(tr("cl_move_last"))
        menu.addSeparator()
        delete = menu.addAction(tr("cl_delete"))
